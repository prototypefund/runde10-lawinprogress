...
def _replace(law_tree: LawTextNode, path: List[LawTextNode], change: dict) -> LawTextNode:
...
def _insert_after(law_tree: LawTextNode, path: List[LawTextNode], change: dict) -> LawTextNode:
...
def _rephrase(law_tree: LawTextNode, path: List[LawTextNode], change: dict) -> LawTextNode:
    return law_tree


def _delete_after(law_tree: LawTextNode, path: List[LawTextNode], change: dict) -> LawTextNode:
